...
<head>
    ...
    <!-- summernote -->
    <link rel="styesheet" href="plugins/summernote/summernote-bs4.min.css">
</head>
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <span class="brand-text font-weight-light">WebError</span>
            </a>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                  <p>Ticket nuevo de error</p>
                                  <p>Arruinar vidas es parte de mi trabajo, ¡Era lo único que se me daba bien en preescolar, aparte de la siesta</p>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2022 <a href="#">WebError</a>.</strong>
